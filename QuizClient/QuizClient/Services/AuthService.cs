...
namespace QuizApp.Services
{
    public class AuthService
    {
        ...
        public async Task<(bool Success, string Message)> RegisterAsync(string username, string email, string nome, string cognome, string genere, string password, string data_nascita)
        {
            var data = new
            {
                username,
